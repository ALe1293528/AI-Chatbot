...
# 智谱 AI API 配置
ZHIPU_API_KEY = os.environ.get('ZHIPU_API_KEY', '4d8ef29268c44cce89a63217e37f3028.PAiEeTyu5nPtq7YR')
ZHIPU_BASE_URL = os.environ.get('ZHIPU_BASE_URL', 'https://open.bigmodel.cn/api/paas/v4')
DEFAULT_MODEL = os.environ.get('DEFAULT_MODEL', 'glm-4')  # 智谱 AI GLM-4 模型
